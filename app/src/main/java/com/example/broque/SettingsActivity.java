...
//
//        totalBudget = findViewById(R.id.settingsTotalBudget);
//        billsBudget = findViewById(R.id.settingsBillsBudget);
//        foodBudget = findViewById(R.id.settingsFoodBudget);
//        entertainmentBudget = findViewById(R.id.settingsEntertainmentBudget);
//        otherBudget = findViewById(R.id.settingsOtherBudget);
//
//        // Finish Button Listener
//        buttonFinish = (Button) findViewById(R.id.Settings_Btn_Finish);
//        this.buttonFinish.setOnClickListener(new View.OnClickListener() {
//            public void onClick(final View v) {
//                //System.out.println("onCreate listener invoked");
//                String total = editFullname.getText().toString();
//                String username = editUsername.getText().toString();
//                String password = editPassword.getText().toString();
//                String phonenumber = editPhone.getText().toString();
//                new SignUp.RegisterButton().execute(fullname, username, password, phonenumber);
//            }// onCLick
//        });// setOnClickListener
//
